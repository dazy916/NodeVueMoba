			...
			<el-form-item label="广告">
				...
				<el-row type="flex" style="flex-wrap:wrap;margin-top: 1rem;">
					<el-col :md="24" v-for="(item, i) in model.items" :key="i">
						<el-form-item label="跳转链接"><el-input v-model="item.url"></el-input></el-form-item>
						...
						<el-form-item style="margin-top: 1rem;"><el-button type="danger" @click="model.items.splice(i, 1)">删除</el-button></el-form-item>
					</el-col>
				</el-row>
			</el-form-item>
